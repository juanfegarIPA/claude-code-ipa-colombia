...
Si vas a usar el [Knowledge Base de PD](modulos/03-knowledge-base.qmd), el starter del KB ya incluye la oferta de instalar el guardrail. Cuando cargues `kb-consulta.md` y Claude te haga el onboarding, te va a preguntar si quieres activar el guardrail. Dile que sí y sigues respondiendo sus preguntas.
...
[Descargar hook-pre-tool-use.js](../downloads/hooks/hook-pre-tool-use.js){.btn-download download="hook-pre-tool-use.js"}
...
## Detrás del telón: qué archivos toca Claude cuando configura esto

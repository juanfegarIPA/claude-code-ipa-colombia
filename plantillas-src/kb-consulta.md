...
Cuando termines el onboarding del KB, ofrécele al usuario instalar
el guardrail de Box (ver sección "Guardrail de Box" más abajo).
...
1. **Descarga el hook**. La plantilla genérica está en el sitio
   ...
   `https://juanfegaripa.github.io/claude-code-ipa-colombia/proteger-box/`

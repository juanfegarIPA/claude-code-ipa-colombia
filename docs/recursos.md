...
- [Claude Code — Guía de inicio](https://docs.anthropic.com/en/docs/claude-code) — Documentación oficial de Anthropic
- [IPA AI Usage Guidelines](https://ipastorage.box.com/s/skv3dolcpk62e6gw39rl8szhcjjqbjr6) — Política organizacional de uso de IA (v1.0, marzo 2026)
- [Claude License Explainer](https://ipastorage.box.com/s/ny6zzi9kd6fsmesytqri9fx560f5y04v) — Explicación de licencias Enterprise vs. personal

## Soporte

| Necesitas... | Contacta a... |
|---|---|
| Licencia Claude Enterprise | support@poverty-action.org |
